...
custom_replacements = {
  ...
  */
  names = {
    ...
    primary_firewall_public_ip_name                              = "pip-prod-afw-$${starter_location_01_short}-001"
    primary_firewall_management_public_ip_name                   = "pip-mgmt-prod-afw-$${starter_location_01_short}-001"
    ...
    primary_virtual_network_gateway_express_route_public_ip_name = "pip-prod-ergw-$${starter_location_01_short}-001"
    primary_virtual_network_gateway_vpn_name                     = "vng-hub-prod-$${starter_location_01_short}-001"
    primary_virtual_network_gateway_vpn_public_ip_name_1         = "pip-prod-vng-$${starter_location_01_short}-001"
    primary_virtual_network_gateway_vpn_public_ip_name_2         = "pip-prod-vng-$${starter_location_01_short}-002"
    ...
    secondary_firewall_public_ip_name                              = "pip-prod-afw-$${starter_location_02_short}-001"
    secondary_firewall_management_public_ip_name                   = "pip-mgmt-prod-afw-$${starter_location_02_short}-001"
    ...
    secondary_virtual_network_gateway_express_route_public_ip_name = "pip-prod-ergw-$${starter_location_02_short}-001"
    secondary_virtual_network_gateway_vpn_name                     = "vng-hub-prod-$${starter_location_02_short}-001"
    secondary_virtual_network_gateway_vpn_public_ip_name_1         = "pip-prod-vng-$${starter_location_02_short}-001"
    secondary_virtual_network_gateway_vpn_public_ip_name_2         = "pip-prod-vng-$${starter_location_02_short}-002"
