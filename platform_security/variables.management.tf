variable "management" {
  type = map(object({
    ...
    # Resource Group
    # Name is optional - auto-generated as: rg-{workload}-{env}-mgmt-{region_abbr}-{instance}
    ...
    # Name is optional - auto-generated as: rsv-{workload}-{env}-{region_abbr}-{instance}
    deploy_management_backup_recovery_services_vault                     = optional(bool, true)
    management_backup_rsv_name                                           = optional(string)
    ...
    # Name is optional - auto-generated as: rsv-asr-{workload}-{env}-{region_abbr}-{instance}
    deploy_management_site_recovery_recovery_services_vault                     = optional(bool, true)
    management_site_recovery_rsv_name                                           = optional(string)
    ...
    # Key Vault
    # Name is optional - auto-generated as: kv{workload}{region_abbr}{instance} (globally unique suffix may be needed)
    deploy_management_key_vault                   = optional(bool, true)
    management_kv_name                            = optional(string)
    management_kv_tenant_id                       = optional(string)
