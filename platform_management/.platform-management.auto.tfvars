...
subscription = "f09a5d16-c8db-4d7c-bce4-a2781c659cde"
...
vending = {
  ...
  uksouth = {
    ...
    #   network:    rg-mgmt-prod-network-uks-001
    #   management: rg-mgmt-prod-mgmt-uks-001
    resource_group_creation_enabled = true
    resource_groups = {
      network = {
        # name         = "rg-mgmt-prod-network-uks-001"  # Auto-generated
        # lock_enabled = false  # Enable resource lock (CanNotDelete)
      }
      management = {
        # name         = "rg-mgmt-prod-mgmt-uks-001"  # Auto-generated
        # lock_enabled = false  # Enable resource lock (CanNotDelete)
      }
    }

    # Virtual Networks
    # Auto-generated name: vnet-mgmt-prod-uks-001
    # /26 VNet - 64 addresses
    virtual_network_enabled = true
    virtual_networks = {
      management = {
        # name = "vnet-mgmt-prod-uks-001"  # Auto-generated
        address_space      = ["10.0.5.0/26"]
        ...
        subnets = {
          jump_servers = {
            name             = "snet-mgmt-prod-jump-uks-001"
            address_prefixes = ["10.0.5.0/28"]
          }
          logicmonitor = {
            name             = "snet-mgmt-prod-lm-uks-001"
            address_prefixes = ["10.0.5.16/28"]
          }
        }
      }
    }
  ...
  ukwest = {
    ...
    resource_groups = {
      network = {
        # name         = "rg-mgmt-prod-network-ukw-001"  # Auto-generated
      }
      management = {
        # name         = "rg-mgmt-prod-mgmt-ukw-001"  # Auto-generated
      }
    }
    ...
    virtual_networks = {
      management = {
        # name = "vnet-mgmt-prod-ukw-001"  # Auto-generated
        address_space      = ["10.1.5.0/26"]
        resource_group_key = "network"
        ...
        subnets = {
          jump_servers = {
            name             = "snet-mgmt-prod-jump-ukw-001"
            address_prefixes = ["10.1.5.0/28"]
          }
          logicmonitor = {
            name             = "snet-mgmt-prod-lm-ukw-001"
            address_prefixes = ["10.1.5.16/28"]
          }
        }
      }
    }
...
management = {
  ...
  uksouth = {
    ...
    management_resource_group_name         = "rg-mgmt-prod-mgmt-uks-001"

    ###########################################################################
    # Backup Recovery Services Vault
    ###########################################################################
    deploy_management_backup_recovery_services_vault   = true
    management_backup_rsv_name                         = "rsv-backup-mgmt-prod-uks-001"
    ...
    management_site_recovery_rsv_name                       = "rsv-asr-mgmt-prod-uks-001"

    ###########################################################################
    # Key Vault - DISABLED (name auto-generated with random suffix)
    ###########################################################################
    deploy_management_key_vault = false
    # management_kv_name        = "kvmgmtuksxxxx001"  # Auto-generated: kv{workload4}{region}{random4}{instance}
  ...
  ukwest = {
    ...
    # Resource Group - use existing (created by vending module)
    use_existing_management_resource_group = true
    management_resource_group_name         = "rg-mgmt-prod-mgmt-ukw-001"

    ###########################################################################
    # Backup Recovery Services Vault
    ###########################################################################
    deploy_management_backup_recovery_services_vault   = true
    management_backup_rsv_name                         = "rsv-backup-mgmt-prod-ukw-001"
    ...
    management_site_recovery_rsv_name                       = "rsv-asr-mgmt-prod-ukw-001"
    ...
    ###########################################################################
    deploy_management_key_vault = false
    # management_kv_name        = "kvmgmtukwxxxx001"  # Auto-generated: kv{workload4}{region}{random4}{instance}
    management_kv_tenant_id     = "6eb56c2c-7ac1-42d9-b587-4d6ec70d05e6"
  }
}
